      ...
      <main className="flex-grow container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">售后政策</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-gray-800 mb-2">退换货政策</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-800 mb-2">保修政策</h3>
                <p className="text-gray-600">
                  1. 账号类商品提供7天质保期。<br />
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-800 mb-2">联系客服</h3>
                <p className="text-gray-600">
          ...
          {/* 售后申请 */}
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">提交售后申请</h2>
            {submitted ? (
